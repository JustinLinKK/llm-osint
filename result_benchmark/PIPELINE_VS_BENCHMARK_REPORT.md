...
This file remains a point-in-time gap analysis against `Benchmark.txt`.
...
Generated per-run reports live under `../reports/benchmark_comparison/` and are disposable outputs.
